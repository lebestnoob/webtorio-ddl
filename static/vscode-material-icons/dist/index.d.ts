...
var file = "file";
var hidesExplorerArrows = false;
var folder = "folder";
var folderExpanded = "folder-open";
var rootFolder = "folder-root";
var rootFolderExpanded = "folder-root-open";
var iconMap = {
...
type FolderNamesKey = keyof (typeof iconMap)['folderNames'];
type FileExtensionsKey = keyof (typeof iconMap)['fileExtensions'];
type MaterialIcon = IconDefinitionsKey;
...
declare function isMaterialIconName(value: unknown): value is MaterialIcon;
declare function getIconUrlByName(iconName: MaterialIcon, iconsUrl: string): string;
declare function getIconUrlForFilePath(path: string, iconsUrl: string): string;
declare function getIconForFilePath(path: string): MaterialIcon;
declare function getIconForDirectoryPath(path: string): MaterialIcon;
declare function getIconInfo(name: MaterialIcon): MaterialIconInfo;

export { type FileExtensionsKey, type FileNamesKey, type FolderNamesKey, type IconDefinitionsKey, MATERIAL_ICONS, type MaterialIcon, type MaterialIconInfo, getIconForDirectoryPath, getIconForFilePath, getIconInfo, getIconUrlByName, getIconUrlForFilePath, isMaterialIconName };
